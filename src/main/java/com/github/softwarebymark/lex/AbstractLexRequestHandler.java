...
public abstract class AbstractLexRequestHandler implements LexRequestHandler {
     ...
     * @return A Lex Response
     */
    protected LexResponse createCloseDialogActionResponse(FulfillmentState fulfillmentState, String message) {
        return new LexResponse(new CloseDialogAction(fulfillmentState, new Message(message)));
    }
    ...
    /**
     * Creates a Lex Request with a Elicit Intent Dialog Action
     *
     * @return A Lex Response
     */
    protected LexResponse createElicitIntentDialogActionResponse() {
        return new LexResponse(new ElicitIntentDialogAction());
    }
     ...
     * @return A Lex Response
     */
    protected LexResponse createElicitIntentDialogActionResponse(String message) {
        return new LexResponse(new ElicitIntentDialogAction(new Message(message)));
    }
     ...
     * @return A Lex Response
     */
    protected LexResponse createElicitIntentDialogActionResponse(String message, ResponseCard responseCard) {
        return new LexResponse(new ElicitIntentDialogAction(new Message(message), responseCard));
    }
     ...
     * @return A Lex Response
     */
    protected LexResponse createElicitIntentDialogActionResponse(ResponseCard responseCard) {
        return new LexResponse(new ElicitIntentDialogAction(responseCard));
    }
