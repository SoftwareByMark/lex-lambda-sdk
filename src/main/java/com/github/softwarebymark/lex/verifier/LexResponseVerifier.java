...
import com.github.softwarebymark.lex.domain.action.DialogActionWithDetails;
...
public class LexResponseVerifier extends AbstractVerifier<LexResponse> {
    ...
    private MessageVerifier messageVerifier = new MessageVerifier();
    private ResponseCardVerifier responseCardVerifier = new ResponseCardVerifier();

    public void verify(LexResponse lexResponse) {
        if (lexResponse.getDialogAction() instanceof DialogActionWithDetails) {
            DialogActionWithDetails dialogActionWithDetails = (DialogActionWithDetails) lexResponse.getDialogAction();
